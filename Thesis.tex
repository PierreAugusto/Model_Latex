...
% Defining acronyms
\input{Sections/0.2-list_of_acronyms.tex}
...
\newcommand{\thesistitle}{A natureza das galáxias anãs ultra compactas} % Thesis title
...
\input{Sections/0.3-reference_macros}

\newpage

% Starting pages
% Title page, signature page, 'original' or 'corrected' version page
\input{Sections/0.4-cover_pages.tex}
% Dedication/inspiring phrase page, acknowledgements page
\input{Sections/0.5-acknowledgements}
% Abstract pages
\input{Sections/0.6-abstract}
% Table of contents, list of figures, list of tables, list of acronyms
\input{Sections/0.7-list_figures_tables}

\newpage

% Content pages
\input{Sections/1-Introducao}
\input{Sections/2-Base de Dados}
\input{Sections/3-Analise}
\input{Sections/4-Conclusao}
\input{Sections/5-future_perspectives.tex}
\input{Sections/6-bibliography}
